...
interface TeamDetailModuleProps {
  id: string;
  locale: string;
}

export async function TeamDetailModule({ id, locale }: TeamDetailModuleProps) {
                  ...
                  <div className="flex flex-wrap gap-4 text-sm text-muted-foreground mt-3">
                    {team.intFormedYear && (
                      <span className="flex items-center gap-1.5">
                        ...
                        {t('founded')}:{' '}
                        <strong className="text-foreground">{team.intFormedYear}</strong>
                      </span>
                    )}
                    {team.strStadium && (
                      <span className="flex items-center gap-1.5">
                        ...
                        {t('stadium')}:{' '}
                        <strong className="text-foreground">{team.strStadium}</strong>
                      </span>
                    )}
